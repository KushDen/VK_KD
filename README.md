...
Смотрите ноутбук Imagewoof_KD.ipynb в первую очередь!!
...
В этом ноутбуке я провожу такие же эксперименты, но с датасетом Imagenette. Отчем также приведен в конце.
